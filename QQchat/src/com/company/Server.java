...
public class Server {
    ...
    public void init() {
        ...
        frame.setTitle("QQ-孤酒暖阳                    服务端");//窗体名称
        frame.setBounds(150, 150, 450, 650);//窗体位置尺寸
        /*文本框组装*/
    ...
    public void myEvent() {
        frame.addWindowListener(new WindowAdapter() {//建立窗口监听
            ...
            public void windowClosing(WindowEvent e) {//点击x则监听
                frame.setDefaultCloseOperation(frame.EXIT_ON_CLOSE);//退出Java虚拟机
            }
        });
